    ...
    <>
      ...
      <main className="overflow-clip bg-[#f4f0e8] text-[#111a16]">
        ...
        <section
          ...
          className="flex min-h-[100svh] snap-start items-center bg-[#e9e5dc] px-5 py-28 sm:px-8 lg:px-14"
        >
            ...
            <div className="mt-14 grid gap-4 md:grid-cols-3">
              {projectTypes.map((project, index) => (
                <motion.article
                  ...
                  className="group min-h-64 rounded-[2rem] border border-[#111a16]/10 bg-white/55 p-7 transition duration-300 hover:-translate-y-2 hover:bg-white hover:shadow-[0_30px_70px_rgba(17,26,22,0.1)]"
                >
                  <span className="text-xs font-black tracking-[0.2em] text-[#758078]">
                    {project.number}
                  </span>
                  <h3 className="mt-16 text-2xl font-black tracking-[-0.035em]">
                    {project.title}
                  </h3>
                  <p className="mt-3 leading-7 text-[#5d6961]">{project.description}</p>
                </motion.article>
              ))}
            </div>
          </div>
        ...
        <section
          ...
          className="flex min-h-[75svh] snap-start items-center bg-[#f4f0e8] px-5 py-28 sm:px-8 lg:px-14"
        >
          <motion.div
          ...
          >
            <p className="text-xs font-black uppercase tracking-[0.28em] text-[#67806e]">Contacto</p>
            <h2
              id="contact-title"
            ...
            <p className="mx-auto mt-7 max-w-2xl text-lg leading-8 text-[#5d6961]">
              Esta sección quedará preparada para conectar el correo, WhatsApp o el formulario definitivo del equipo.
            </p>
            <a
              href="#home"
              className="mt-9 inline-flex items-center gap-3 rounded-full bg-[#111a16] px-7 py-4 text-sm font-black text-white transition hover:-translate-y-1 hover:bg-[#283b31] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#5c7c67] focus-visible:ring-offset-4"
            >
              Volver al inicio
